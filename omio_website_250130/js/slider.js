    ...
    $slider.mousemove(function(e){ // Get the cursor position
        ...
        if($sldr.hasClass('multi-slides')){
            ...
            if($mousePos.x > $sldr.width()/2) {
              $sldr.find('.slides').css('cursor', 'url(http://omiostudio.com/images/btn/slide-right-dark.png) 5 -25, e-resize');
              if($('body').hasClass('dark-hero'))
                $sldr.find('.slides').css('cursor', 'url(http://omiostudio.com/images/btn/slide-right.png) 5 -25, e-resize');
            } else {
              $sldr.find('.slides').css('cursor', 'url(http://omiostudio.com/images/btn/slide-left-dark.png) 5 -25, w-resize');
              if($('body').hasClass('dark-hero'))
                $sldr.find('.slides').css('cursor', 'url(http://omiostudio.com/images/btn/slide-left.png) 5 -25, w-resize');
            }
